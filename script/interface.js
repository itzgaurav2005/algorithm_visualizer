...
function runAlgo() {
    ...
    if (algo === "binary-search") {
        elements.sort((a, b) => order === "asc" ? a - b : b - a);
        updateBars(elements);
    }
...
// Keep ONLY one version of getElements()
...
function solve(algo, order, input) {
    switch (algo) {
        case "bubble": return Algorithms.bubble(input, order);
        case "comb": return Algorithms.comb(input, order);
        case "heap": return Algorithms.heap(input, order);
        case "insertion": return Algorithms.insertion(input, order);
        case "selection": return Algorithms.selection(input, order);
        case "shell": return Algorithms.shell(input, order);
        case "binary-insertion": return Algorithms.binaryInsertion(input, order);
        case "binary-search": return Algorithms.binarySearch(input, order);
